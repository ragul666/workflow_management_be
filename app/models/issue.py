...
class Issue(Base):
    ...
    category: Mapped[str] = mapped_column(String(50), nullable=False, default="compliance", index=True)
    ...
    audit_logs = relationship("AuditLog", back_populates="issue", lazy="noload")
    ai_summaries = relationship("AISummary", back_populates="issue", lazy="noload")
    attachments = relationship("Attachment", back_populates="issue", lazy="noload")
